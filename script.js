...
tsParticles.load("particles-js", {
  particles: {
    ...
    color: {
      value: ["#ff9500", "#e6b980", "#FF5733"] // Theme-matching colors
    },
    shape: {
      type: "circle", // Particle shape (circle)
    },
    opacity: {
      value: 0.8, // Make particles semi-transparent
    ...
    shadow: {
      enable: true,
      blur: 10, // The blur effect to simulate glow
      color: "#ff9500" // Glow color matching your theme
    },
    move: {
      enable: true,
      ...
      random: false,
      straight: false,
      out_mode: "out", // Particles move out of bounds and respawn
      bounce: false
    }
  },
  interactivity: {
    ...
    events: {
      onhover: {
        enable: true,
        mode: "repulse" // When hovered, particles are repulsed
      }
    },
    modes: {
      repulse: {
